...
const messages = {
  en: {
    ...
    "recording.versionNumber": ({ current, total }) =>
      `Version ${current} of ${total}`,
    "recording.openYoutube": "Open in YouTube",
    ...
    "source.youtubeRecording": "Open in YouTube",
    "source.youtubeSearch": "Find the recording on YouTube",
  ...
  fr: {
    ...
    "recording.version": "Version",
    "recording.versionNumber": ({ current, total }) =>
      `Version ${current} sur ${total}`,
    "recording.openYoutube": "Ouvrir dans YouTube",
    ...
    "source.youtubeRecording": "Ouvrir dans YouTube",
    "source.youtubeSearch": "Chercher l’enregistrement sur YouTube",
    "source.copied": "Copié",
